...
class Employee(NestedSet):
	...
	def validate(self):
		...
		###custom code for creating leave allocation based on leave settings(field=personal leave)
		if self.is_new():
	...
	def create_leave_allocation(self):
		...
		la.employee = self.name
		la.from_date = self.date_of_joining
		...
		if x[2] < '15':
				...
				tot_la = pd * current_month
				la.new_leaves_allocated = tot_la
		else:
...
def get_employees_who_are_born_today():
	...
	print('emp_born '+str(employees_born_today))
